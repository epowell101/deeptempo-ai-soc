...
def get_palo_alto_config():
    """Get Palo Alto Networks configuration from integrations config."""
    try:
        from ui.integrations_config import IntegrationsConfigDialog
        config = IntegrationsConfigDialog.get_integration_config('palo_alto')
        return config
    except Exception as e:
        logger.error(f"Error loading Palo Alto Networks config: {e}")
        return {}
